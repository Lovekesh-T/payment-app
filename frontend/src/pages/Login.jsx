        ...
        <form className="flex flex-col gap-3" onSubmit={action}>
          ...
          {isLoading ? (
            <button
              disabled={isLoading}
              type="submit"
              className="text-white bg-black hover:bg-gray-900  focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded text-sm px-5 py-2.5 text-center mr-2dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700inline-flex items-center"
            >
              <svg
                aria-hidden="true"
                role="status"
